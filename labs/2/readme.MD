...
root@f1eac0505442:/home#
```
At this point, you have a basic Ubuntu machine on which to test build the project, you are logged into it, and you can use `apt-get` to pull any other tooling you might need. 
